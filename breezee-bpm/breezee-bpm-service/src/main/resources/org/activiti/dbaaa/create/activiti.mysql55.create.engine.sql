...
insert into BPM_ACT_GE_PROPERTY
...
alter table BPM_ACT_GE_BYTEARRAY
    ...
    references BPM_ACT_RE_DEPLOYMENT (ID_);

alter table BPM_ACT_RE_PROCDEF
...
alter table BPM_ACT_RU_EXECUTION
    ...
    references BPM_ACT_RU_EXECUTION (ID_) on delete cascade on update cascade;

alter table BPM_ACT_RU_EXECUTION
    add constraint ACT_FK_EXE_PARENT 
    foreign key (PARENT_ID_) 
    references BPM_ACT_RU_EXECUTION (ID_);
...
alter table BPM_ACT_RU_EXECUTION
    ...
    references BPM_ACT_RE_PROCDEF (ID_);
    
alter table BPM_ACT_RU_IDENTITYLINK
    add constraint ACT_FK_TSKASS_TASK 
    foreign key (TASK_ID_) 
    references BPM_ACT_RU_TASK (ID_);
...
alter table BPM_ACT_RU_VARIABLE 
    ...
    references BPM_ACT_GE_BYTEARRAY (ID_);
