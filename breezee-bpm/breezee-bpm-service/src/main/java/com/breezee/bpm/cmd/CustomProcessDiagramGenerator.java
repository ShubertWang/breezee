package com.breezee.bpm.cmd;

import com.breezee.bpm.graph.ActivitiHistoryGraphBuilder;
import com.breezee.bpm.graph.Edge;
import com.breezee.bpm.graph.Graph;
...
public class CustomProcessDiagramGenerator {
    ...
    public InputStream generateDiagram(String processInstanceId)
        ...
        //调整x,y来调整流程图片的相关坐标
        //minX,minY可以调整我们自己添加上去的位置。point则可以调整原生的节点位置
        this.minX = point.x;
        this.minY = point.y;
    ...
    private void checkGraphicInfo(List<GraphicInfo> graphicInfoList,
                                  double theMaxX, double theMinX, double theMaxY, double theMinY){
    ...
    protected Point getMinXAndMinY(BpmnModel bpmnModel) {
        ...
        double theMinX = java.lang.Double.MAX_VALUE,
                theMaxX = 0, theMinY = java.lang.Double.MAX_VALUE,theMaxY = 0;
        ...
        for (FlowNode flowNode : flowNodes) {
            ...
            for (SequenceFlow sequenceFlow : flowNode.getOutgoingFlows()) {
                ...
                checkGraphicInfo(graphicInfoList, theMaxX, theMinX, theMaxY, theMinY);
            }
        }
